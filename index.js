...
var jsonret = {karma: karma, level: levelcheerio.text(),parkours_Completed: parkours, friends: friends, last_Login: lastlogin, general_Achievements: generalachi, achievement_Points: achipoint, guild: guild}
return jsonret
      })
    },
...
if(substringyapgenebruh !== "") {
 ...
 guildmaster = arr[7]
 members = arr[11]
  var jsonret = {created_At: createdat, guild_Master: guildmaster, member_Count: members, guild_Level: guildlevel, members: memberarray}
  return jsonret
